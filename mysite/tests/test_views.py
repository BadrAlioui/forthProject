...
class TestHomePage(TestCase):
    ...
    def test_home_page(self):
        """
        Ensure that the home page loads successfully and uses 'home.html' as its template.
        """
    ...
    def test_contact_page(self):
        """
        Ensure that the contact page loads successfully and uses 'contact.html' as its template.
        """
