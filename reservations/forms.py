...
It is linked to the Reservation model and customizes the input for the booking date and time.
"""
...
class ReservationForm(forms.ModelForm):
    ...
    This form customizes the 'date_booking' field to use an HTML5 datetime-local input,
    which allows users to easily select both a date and a time. The 'user' field is excluded
