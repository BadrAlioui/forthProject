...
class ReservationViewsTest(TestCase):
    ...
    def test_liste_reservation_get(self):
        ...
        The view should render the appropriate template and show reservation details.
        """
    ...
    def test_liste_reservation_post_valid(self):
        ...
        After posting valid data, the view should redirect and the new reservation should exist.
        """
    ...
    def test_edit_reservation_get(self):
        ...
        It should render the edit template and display the current reservation details.
        """
    ...
    def test_edit_reservation_post_valid(self):
        ...
        The reservation should be updated with the new data and the view should redirect.
        """
        response = self.client.post(
    ...
    def test_access_without_login(self):
        ...
        When not logged in, accessing the reservations page should redirect to login.
        """
        self.client.logout()
        response = self.client.get(reverse("reservations:reservations"))
